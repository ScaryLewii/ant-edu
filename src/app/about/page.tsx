...
import AboutBackground from "public/background/about-bg.jpg";
import Slider from "./slider";

export default function About() {
	return (
		<main className="flex h-screen overflow-hidden flex-col items-center justify-center">
			<Image src={AboutBackground} width={1920} height={1080} alt="home background"
				className="absolute top-0 left-0 w-full h-full object-cover" />

			<div className="container flex justify-center items-end z-20 h-full pb-[80px] gap-[120px]">
