...
export default function Partner() {
	return (
		<section className="flex h-screen overflow-hidden flex-col items-center justify-end relative">
			...
			<section className="bg-[#001730] bg-opacity-40 py-[80px] z-20 w-full mt-[90px]">
				<div className="container mx-auto">
					...
					<div className="flex justify-center items-center gap-[100px] my-[50px]">
