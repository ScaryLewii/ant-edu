...
const GuideStep = () => {
	...
	return (
		...
		<div className="mx-auto mt-[80px] max-w-[888px]">
			<div>
			<p>Chúng tôi sẽ hỗ trợ bạn hoàn thiện thủ tục đăng ký nhanh chóng và hiệu quả nhất. <Link href="#" className="font-bold text-cyan underline">Tại đây,</Link> bạn có thể chọn lịch thi phù hợp, điền thông tin cá nhân và thực hiện thanh toán phí thi. </p>
			<br /><br />
